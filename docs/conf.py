...
version = ".".join(myday.__version__.split(".")[:2])  # Short X.Y version
release = myday.__version__  # Full version, with tags

# -- HTML output
templates_path = ["_templates"]
html_static_path = ["_static"]
html_theme = "nengo_sphinx_theme"
html_title = "MyDay {0} docs".format(release)
htmlhelp_basename = "MyDay"
