...
*********************
Contributing to MyDay
*********************

Issues and pull requests are always welcome!
We appreciate help from the community to make MyDay better.

Filing issues
=============

If you find a bug in MyDay,
or think that a certain feature is missing,
please consider
`filing an issue <https://github.com/tbekolay/myday/issues>`_!
...
If you want to fix a bug or add a feature to MyDay,
